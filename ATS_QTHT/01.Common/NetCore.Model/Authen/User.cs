...
namespace NetCore.Models
{
    public class User : MasterCommonModel
    {
        ...
        public Boolean? is_sync_bank_account { get; set; }
        public Boolean? is_partner_admin { get; set; }
        public Boolean is_agency_admin { get; set; }
        ...
        public Boolean? is_accept_policy { get; set; }
        public int? agency_id { get; set; }
        public DateTime? accept_policy_date { get; set; }
        public Boolean? is_partner_branch { get; set; }
        public int? partner_branch_id { get; set; }
        public Boolean? is_partner_branch_admin { get; set; }
