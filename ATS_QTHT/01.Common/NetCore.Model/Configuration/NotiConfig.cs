...
namespace NetCore.Models
{
    public class NotiConfig : MasterCommonModel
    {
        ...
        public string? Payment_Cashback_Success { get; set; } //Thông báo hoàn tiền thành công
        public string? Payment_Cashback_Fail { get; set; } //Thông báo hoàn tiền thất bại
        ...
        public string? MC_ChangePoint_Success { get; set; } //Đổi điểm - Đi tiền thành công

        public string? MC_amount_bill { get; set; } //merchant - Hạn mức tối thiểu 
        
        public string? ChangePoint_Success { get; set; } //Thông báo đổi điểm thành công
        public string? Add_Point_Affiliate { get; set; } //Thông báo cộng điểm affiliate
    }
}