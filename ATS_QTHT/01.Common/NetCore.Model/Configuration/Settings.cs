...
namespace NetCore.Models
{
    public class Settings : MasterCommonModel
    {
        ...
        public string? sharing_policy { get; set; }
        ...
        public int? free_month { get; set; } 
        public int? free_transaction_no { get; set; }
        public int? min_cashback_amount { get; set; } // số tiền tối thiểu để nhận cashback
        public int? min_bk_realtime_payment_amount { get; set; } // số tiền tối thiểu để bảo kim pay realtime
